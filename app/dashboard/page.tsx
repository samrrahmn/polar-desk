        ...
        >
          <div className="bg-surface w-full max-w-2xl rounded-xl border border-default shadow-md overflow-hidden">
            <div className="relative">
              <div className="pointer-events-none absolute top-0 left-0 right-0 h-6 bg-gradient-to-b from-[rgb(var(--surface))] to-transparent z-10"></div>
              <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-[rgb(var(--surface))] to-transparent z-10"></div>
